...
type Mutation{ 
    ...
    """Project Mutations"""    
    addproject(name: String, description: String, teamname: String, numberofteammembers: Int, numberofsprints: Int, velocity: Int, storypointconversion: Int, costperhour:Int): Project,
    updateproject(name:String,teamname:String,numberofteammembers: Int, numberofsprints: Int, velocity: Int): Project
