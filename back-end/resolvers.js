...
const resolvers = {
  ...
  getallproject: async () => {
    ...
    return await dbRtns.findAll(db, projectinfo, {}, {});
  },
  ...
  addproject: async (args) => {
    let db = await dbRtns.getDBInstance();
    let project = `{"name":"${args.name}", "description":"${args.description}", "teamname": "${args.teamname}","numberofteammembers":${args.numberofteammembers},"numberofsprints":${args.numberofsprints}, "velocity":${args.velocity}, "storypointconversion": ${args.storypointconversion},"costperhour":${args.costperhour}}`;
